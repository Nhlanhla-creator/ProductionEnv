...
export default function AssociatorInstructions() {
  return (
    <div className={styles.instructionsWrapper}>
      ...
      <div className={styles.card}>
        ...
        <ul className={styles.bulletList}>
          <li>Create your comprehensive associator profile</li>
          <li>Match you with relevant opportunities, partners, and members</li>
          <li>Verify your organisation's legitimacy and compliance status</li>
          <li>Provide personalized recommendations and support</li>
          <li>Generate insights to help grow your association and network</li>
        </ul>
      </div>
      <div className={styles.card}>
