...
export default function AssociatorDeclarationConsent({ data = {}, updateData }) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className={`${styles.card} mb-8`}>
          <h3 className={`${styles.subtitle} text-lg font-semibold mb-4`}>
            Opt-in for Promotional Visibility (optional)
          </h3>
          <p className="text-brown-700 mb-4">
            By opting in, you agree to allow us to highlight your profile, organisation, or contribution across our
            promotional channels, including newsletters, social media, and featured listings. This is a great
            opportunity to increase your visibility within the community and attract more engagement or collaboration.
            Participation is entirely optional and can be withdrawn at any time.
          </p>
          <div className="mt-4">
            <label className="flex items-center">
              <input
                ...
                required
              />
              <span className="ml-2 text-brown-700">We consent to our association being listed publicly</span>
            </label>
          </div>
        </div>
