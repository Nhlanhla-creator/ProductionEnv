...
const ProgramSponsorSettings = () => {
  ...
  const handleDeleteRole = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setRoles(["Program Director", "Sponsorship Manager", "Partnership Lead"])
            ...
            <div style={{ marginTop: "48px" }}>
              ...
              >
                <div style={{ marginBottom: "20px" }}>
                  ...
                  >
                    Permanently remove one of your program sponsor roles. This action cannot be undone.
                  </p>
                  <button
                ...
                <div>
                  ...
                  >
                    Permanently delete your program sponsor account and all associated data. This action cannot be
                    undone.
                  </p>
                  <button
            ...
            <div style={{ display: "grid", gap: "24px" }}>
              {Object.entries(formData.notifications).map(([key, value]) => {
                const labels = {
                  ...
                  matchAlerts: { title: "Program Alerts", desc: "Get notified about new program opportunities" },
...
export default ProgramSponsorSettings
