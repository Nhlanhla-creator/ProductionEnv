...
export const documentsList = [
  {
    id: "companyRegistrationDocuments",
    label: "Company Registration Documents",
    accept: ".pdf,.doc,.docx,.jpg,.jpeg,.png",
    required: true,
    multiple: false,
    description: "Official company registration documents (e.g., CIPC certificate)",
  },
  {
    id: "idOfFundLead",
    ...
    required: true,
    multiple: false,
    description: "National ID or passport copy of the primary fund lead/contact person",
  },
  {
    id: "investmentMandateOrProgrammeBrochures",
    label: "Investment Mandate or Programme Brochures",
    accept: ".pdf,.doc,.docx",
    required: false, // This document is optional
    multiple: true,
    description: "Documents outlining your investment mandate or program brochures",
  },
]

export default function ProgramSponsorRequiredDocuments({ data = {}, updateData }) {
  ...
  useEffect(() => {
    const loadDocuments = async () => {
      try {
        ...
        // Load from the programSponsorProfiles collection
        const docRef = doc(db, "programSponsorProfiles", userId)
   ...
   const handleFileChange = async (documentId, fileList) => {
    ...
    try {
      ...
      for (const file of fileList) {
        const fileRef = ref(storage, `programSponsorDocuments/${userId}/${documentId}/${file.name}`)
  ...
  if (isLoading) {
    return (
      ...
      >
        ...
        >
          Program Sponsor Documents Upload
        </h2>
        <div
          style={{
            display: "flex",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          🏢 Program Sponsor Profile Verification
        </h3>
        <p
          style={{
            color: "#6d4c41",
        ...
        >
          Upload your documents to complete your program sponsor profile verification. This helps us verify your entity
          and program details.
        </p>
        <div
          style={{
