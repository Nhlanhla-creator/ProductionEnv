...
import { ProgramSponsorDealflow } from "./program-sponsor-deal-flow-pipeline"
import ProgramSponsorTabbedTables from "./program-sponsor-tabbed-tables"
import styles from "./program-sponsor.module.css"
import { X, ArrowRight } from 'lucide-react'

const onboardingSteps = [
  {
    title: "Welcome to Program Sponsor Dashboard",
    content: "This page helps you manage your intern programs and track placements across your organization.",
    icon: "🎯",
  },
  {
    title: "Deal Flow Pipeline",
    content: "Track your intern placement process from matching to completion and rating.",
    icon: "📊",
  },
  {
    title: "Program Insights",
    content: "Get valuable analytics about placement volumes, SME participation, intern performance, and absorption rates.",
    icon: "📈",
  },
  {
    title: "Manage Your Interns",
    content: "View and manage all interns in your programs with detailed profiles and performance tracking.",
    icon: "🤝",
  },
]
...
export default function ProgramSponsorMatchesPage() {
  ...
  useEffect(() => {
    ...
    const storageKey = getUserSpecificKey("hasSeenProgramSponsorPopup")
