...
const complianceFrameworkOptions = [
  { value: "king_iv", label: "King IV Code" },
  { value: "companies_act", label: "Companies Act" },
  { value: "bee_codes", label: "B-BBEE Codes" },
  { value: "jse_listings", label: "JSE Listings Requirements" },
  { value: "pfma", label: "PFMA" },
  { value: "international_standards", label: "International Standards" },
  { value: "other", label: "Other" },
];
...
export default function OwnershipManagement({ data = { shareholders: [], directors: [] }, updateData }) {
  ...
  return (
    <div>
      ...
      {/* 4.5 Transparency & Reporting Section */}
      <div style={{ marginTop: '2rem', marginBottom: '1.5rem' }}>
        <h3 style={{ marginBottom: '1rem', borderBottom: '2px solid #e5e7eb', paddingBottom: '0.5rem' }} className="text-lg font-semibold text-brown-700">
