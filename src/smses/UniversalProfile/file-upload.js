...
export default function FileUpload({
  ...
  const handleFileChange = async (e) => {
    ...
    const newFiles = multiple ? [...(Array.isArray(files) ? files : []), ...selectedFiles] : selectedFiles
    setFiles(newFiles)
  ...
  const handleDrop = async (e) => {
    ...
    const newFiles = multiple ? [...safeFiles, ...droppedFiles] : droppedFiles
    setFiles(newFiles)
    ...
    <div style={styles.container}>
      ...
      {safeFiles.length > 0 && (
        <div style={styles.filesContainer}>
          <p style={styles.filesLabel}>Files ({safeFiles.length}):</p>
