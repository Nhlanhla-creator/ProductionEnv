  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <>
          {/* Stage cards — `items-stretch` here and `h-full` on each card body
              keep a two-line name from making one card shorter than the rest. */}
              ...
              <div key={stage.id} className="flex items-stretch">
                ...
                {idx < LIVE_STAGES.length - 1 &&
                  (() => {
                    ...
                    return (
                      <div
                        className="flex flex-col items-center justify-center px-0.5 flex-shrink-0"
                        style={{ minWidth: "34px" }}
                      >
                        <span
