  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isComplete ? "Analysis Complete!" : "Analyzing Suppliers"}
        </h2>
        ...
        >
          {isComplete
            ? "Your supplier matches are ready with AI-powered insights."
            : "Finding the best supplier matches for your request. This may take a moment."}
        </p>
        ...
        {!isComplete && total !== null && (
          <>
            ...
            >
              <span style={{ color: "#666" }}>Analyzing suppliers</span>
              <span
                style={{
                  fontWeight: 600,
                  color: "#a67c52",
