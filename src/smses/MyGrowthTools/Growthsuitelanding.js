        ...
        <div style={{
          ...
          {showFullDescription && (
            <div style={{
              ...
              <h3 style={{ color: '#5d4037', marginTop: 0, marginBottom: '15px', fontSize: '18px' }}>
                About the BIG Growth Suite
              </h3>
              <p style={{ color: '#4a352f', fontSize: '14px', lineHeight: '1.6', marginBottom: '15px' }}>
                The BIG Growth Suite is a comprehensive decision support and risk management platform designed 
                specifically for growing businesses. It helps founders, executives, and investors understand 
                business health, identify risks early, and make informed strategic decisions.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div>
                  <h4 style={{ color: '#5d4037', marginBottom: '10px', fontSize: '15px' }}>Key Benefits:</h4>
                  <ul style={{ color: '#4a352f', fontSize: '13px', lineHeight: '1.6', margin: 0, paddingLeft: '20px' }}>
                    <li>Real-time health monitoring across all business dimensions</li>
                ...
                <div>
                  <h4 style={{ color: '#5d4037', marginBottom: '10px', fontSize: '15px' }}>Who It's For:</h4>
                  <ul style={{ color: '#4a352f', fontSize: '13px', lineHeight: '1.6', margin: 0, paddingLeft: '20px' }}>
            ...
            {!isInvestorView && (
              <div style={{
                ...
                <div style={{
                  ...
                  {[
                    { name: "Company Health", status: "active", description: "Overall business health monitoring" },
                    { name: "ESG Impact", status: "active", description: "Environmental, social, and governance tracking" },
                    { name: "Financial Health", status: "coming-soon", description: "Deep financial analysis and forecasting" },
                    { name: "Risk Assessment", status: "active", description: "Comprehensive risk identification" },
                    { name: "Growth Planning", status: "coming-soon", description: "Strategic growth and scaling tools" },
                    { name: "Investor Readiness", status: "active", description: "Prepare for funding and investment" }
                  ].map((module, index) => (
                    <div key={index} style={{
                      backgroundColor: '#fdfcfb',
                      padding: '15px',
