...
import { AcceleratorFlowPipeline } from "./accelerator-flow-pipeline"
import AcceleratorTabbedTables from "./accelerator-tabbed-tables"
...
const onboardingSteps = [
  {
    title: "Welcome to Catalyst Programs",
    content: "This page helps you discover and track catalyst programs that can boost your startup's growth and development.",
    icon: "🚀",
  },
  {
    title: "Catalyst Pipeline",
    content: "Track your accelerator applications from initial submission through to program completion and graduation.",
    icon: "📊",
  },
  {
    title: "Program Insights",
    content: "Get valuable analytics about accelerator trends, success rates, and programs that align with your industry.",
    icon: "📈",
  },
  {
    title: "Find Your Match",
    content: "Use filters to discover accelerator programs based on stage, industry focus, location, and equity requirements.",
    icon: "🎯",
  },
]
...
export default function SupportProgramsPage() {
      ...
      if (user) {
        try {
          ...
          const apps = snapshot.docs
            .filter(doc => doc.data().smeId === user.uid)
  ...
  useEffect(() => {
    ...
    const storageKey = getUserSpecificKey("hasSeenAcceleratorPopup")
