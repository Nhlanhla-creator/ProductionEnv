...
/* ════════════════════════════════════════════════════════════════════════════
   ...
   here. Widths raised across the board: each header carries a grip, a sort and
   a filter control (~60px of chrome), so the old 116–186px columns left too
   little room for the label and the browser broke it mid-word.
   ════════════════════════════════════════════════════════════════════════ */
const COLUMN_DEFS = {
  productService: { label: "Product / Service", width: 210, filterType: "productService", visible: true, priority: 2, sortable: true },
  dealAmount: { label: "Deal Value", width: 152, filterType: "dealAmount", visible: true, priority: 2, sortable: true },
  ...
  location: { label: "Location", width: 152, filterType: "location", visible: false, priority: 4, sortable: true },
  matchPercentage: { label: "Match %", align: "center", width: 138, filterType: "matchPercentage", visible: false, priority: 4, sortable: true },
  bbbeeLevel: { label: "B-BBEE Level", width: 162, filterType: "bbbeeLevel", visible: false, priority: 4, sortable: true },
  requestedAt: { label: "Date Requested", width: 164, filterType: "requestedAt", visible: false, priority: 4, sortable: true },
}
...
const VIEWS_STORAGE_KEY = "supplier-deals-views-v2"
