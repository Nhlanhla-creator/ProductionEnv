          ...
          messages: [
            {
              role: "system",
              content:
                "You are an expert business analyst specializing in legitimacy assessment. Provide detailed, professional evaluations based on the BIG Legitimacy Scorecard rubric.",
            },
            {
              role: "user",
              content: message,
