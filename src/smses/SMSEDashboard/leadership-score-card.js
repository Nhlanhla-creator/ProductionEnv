          ...
          messages: [
            {
              role: "system",
              content:
                "You are an expert business analyst specializing in leadership assessment. Provide detailed, professional evaluations based on the Leadership Scorecard rubric.",
            },
            {
              role: "user",
              content: message,
