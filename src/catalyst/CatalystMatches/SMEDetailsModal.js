...
const SMEDetailsModal = ({ sme, isOpen, onClose }) => {
                    ...
                    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", padding:"24px" }}>
                        <div>
                            ...
                            <div style={{ display:"flex", gap:"12px", flexWrap:"wrap" }}>
                                ...
                                {sme.programName && (
                                    <span style={metaBadgeStyle}>{sme.programName}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div style={tabContentStyle}>
                            <div style={gridStyle}>
                                ...
                                <div style={cardStyle}>
                                    ...
                                    <InfoItem label="Accelerator"     value={sme.acceleratorName} />
                                    <InfoItem label="Program"         value={sme.programName} />
                                </div>
                            </div>
                        </div>
                    )}
...
export default SMEDetailsModal