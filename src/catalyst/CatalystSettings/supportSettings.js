...
const CatalystSettings = () => {
  ...
  const handleDeleteRole = async () => {
    ...
    setTimeout(() => {
      setRoles(["Catalyst Lead", "Innovation Manager", "Program Coordinator"])
              ...
              <div style={{ marginTop: "48px" }}>
                ...
                >
                  <div style={{ marginBottom: "20px" }}>
                    ...
                    >
                      Permanently remove one of your catalyst roles. This action cannot be undone.
                    </p>
                    <button
                  ...
                  <div>
                    ...
                    >
                      Permanently delete your catalyst account and all associated data. This action cannot be undone.
                    </p>
                    <button
      ...
      {showDeleteRolePopup && (
        ...
        >
          ...
          >
            ...
            >
              Select which catalyst role you want to delete:
            </p>
            <div style={{ marginBottom: "20px" }}>
      ...
      {showDeleteAccountPopup && (
        ...
        >
          ...
          >
            ...
            >
              Are you sure you want to delete your catalyst account? This action cannot be undone and will permanently
