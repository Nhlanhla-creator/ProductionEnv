...
const Availability = ({ onSubmit, workingHours: existingHours, showAsCard = false, onEditClick }) => {
    ...
    return (
      <div className="availability-card">
        <div className="card-header">
          <h3>Facilitation Availability</h3>
        ...
        {availabilities.length > 0 ? (
          ...
          <p className="no-availability">No facilitation availability set</p>
        )}
      </div>
    );
  }
  ...
  return (
    <div className="availability-schedule">
      <h2>Set Facilitation Availability</h2>
      <p>Select dates and specify open office hours for cohort sessions, SME advisory reviews, and investor syncs</p>
      ...
      <div className="date-selection">
        ...
        >
          + Add Facilitation Dates
        </button>
      </div>

      {availabilities.length > 0 && (
        <div className="availability-list">
          <h3>Active Facilitation Windows</h3>
          {availabilities
      ...
      <div className="save-button-container">
        ...
        >
          Save Facilitation Availability
        </button>
      </div>
    </div>
  );
