...
import InvestorTabbedTables from "./investor-tabbed-tables"
import styles from "./smse.module.css"

const onboardingSteps = [
  {
    title: "Welcome to Your SME Investment Dashboard",
    content:
      "This dashboard provides you with tools to discover, analyze, and manage potential investment opportunities.",
    icon: "💼",
  },
  {
    title: "Deal Flow Pipeline",
    content:
      "Track your investment opportunities at each stage of the pipeline, from initial contact to closing the deal.",
    icon: "📊",
  },
  {
    title: "Investment Insights",
    content:
      "Get valuable analytics and insights about market trends, performance metrics, and investment opportunities.",
    icon: "📈",
  },
  {
    title: "Filter SMEs",
  ...
  {
    title: "SME Opportunities & Portfolio",
    content: "Browse through potential investment opportunities and manage your existing portfolio companies.",
    icon: "🤝",
  },
]
...
export default function InvestorDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState("sme-opportunities")
  ...
  useEffect(() => {
    ...
    const storageKey = getUserSpecificKey("hasSeenInvestorPopup")
