...
const BillingHistoryInvestors = ({
  ...
  function generateInvoicePDF(transaction) {
    ...
    doc.setFontSize(16)
    doc.setTextColor(hexToRgb(colors.mediumBrown)[0], hexToRgb(colors.mediumBrown)[1], hexToRgb(colors.mediumBrown)[2])
    ...
    // Table Header
    doc.setFillColor(hexToRgb(colors.cream)[0], hexToRgb(colors.cream)[1], hexToRgb(colors.cream)[2]) // light beige
    ...
    // Table Row
    doc.setTextColor(hexToRgb(colors.darkBrown)[0], hexToRgb(colors.darkBrown)[1], hexToRgb(colors.darkBrown)[2])
    ...
    doc.setFillColor(hexToRgb(colors.lightBrown)[0], hexToRgb(colors.lightBrown)[1], hexToRgb(colors.lightBrown)[2])
...
export default BillingHistoryInvestors
