...
import { OPS_STRUCTURE } from './structure/opsStructure';
import {
  uploadFile,
  deleteFile,
  loadContent,
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-brown)' }}>
            {authLoading ? 'Authenticating...' : 'Loading operations...'}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: '#666' }}>Please log in to access Operations & Internal.</p>
        </div>
      </div>
    );
  }
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{
            ...
            Organizational structure, SOPs, training, and internal documentation
          </p>
        </div>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center', padding: 40 }}>
                ...
                <p style={{ color: '#666', margin: 0 }}>
                  Select an operations section from the explorer to begin
                </p>
              </div>
            </div>
          )}
...
export default OperationsInternal;