...
const COLLECTION = 'reports_content';
const STRUCTURE_COLLECTION = 'reports_structure';
...
export const uploadFile = async (path, file) => {
  try {
    ...
    const storagePath = `reports/${user.uid}/${path.map(s => s.replace(/\s+/g, '_')).join('/')}/${fileName}`;
