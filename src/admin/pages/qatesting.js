      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-brown)' }}>
            {authLoading ? 'Authenticating...' : 'Loading QA tests...'}
          </p>
        </div>
      </div>
    );
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{
            ...
            Test documentation, reports, and datasets
          </p>
        </div>
          ...
          {!selectedPath && (
            <div style={{
              ...
              <div style={{ textAlign: 'center', padding: 40 }}>
                <AlertCircle size={48} color="var(--accent-brown)" style={{ marginBottom: 16 }} />
                <h3 style={{ color: 'var(--text-brown)', marginBottom: 8 }}>No Test Selected</h3>
                <p style={{ color: '#666', margin: 0 }}>
                  Select a test category from the explorer to begin
                </p>
              </div>
            </div>
          )}
