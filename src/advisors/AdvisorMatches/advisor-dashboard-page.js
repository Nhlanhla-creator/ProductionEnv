...
import { AdvisorDealFlowPipeline } from "./advisor-deal-flow"

import AdvisorTabbedTables from "./advisor-tabbed-tables"
import styles from "./smse.module.css"

const onboardingSteps = [
  {
    title: "Welcome to Your Advisor Dashboard",
    content:
      "This dashboard provides you with tools to discover, analyze, and manage potential advisory opportunities.",
    icon: "💼",
  },
  {
    title: "Advisory Flow Pipeline",
    content:
      "Track your advisory opportunities at each stage of the pipeline, from initial contact to active advisory relationships.",
    icon: "📊",
  },
  {
    title: "Advisory Insights",
    content:
      "Get valuable analytics and insights about market trends, performance metrics, and advisory opportunities.",
    icon: "📈",
  },
  {
    title: "Filter SMSEs",
    content: "Use powerful filters to find the perfect advisory match based on location, industry, stage, and more.",
    icon: "🔍",
  },
  {
    title: "SMSE Opportunities",
    content: "Browse through potential advisory opportunities and take action on the ones that match your criteria.",
    icon: "🤝",
  },
]
  ...
  return (
    <div style={getContainerStyles()} className={styles.pageContainer}>
      ...
      >
        ...
        >
          <AdvisorTabbedTables filters={filters} stageFilter={stageFilter} loading={loading} />
        </div>
      </div>
    </div>
  )
