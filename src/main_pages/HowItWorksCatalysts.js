      ...
      <div style={styles.container}>
        ...
        <section style={styles.heroSection}>
          <div style={styles.heroContent}>
            <h1 style={styles.mainTitle}>How BIG Works for Catalysts</h1>
        ...
        <div style={styles.contentContainer}>
          ...
          <div style={styles.stepsContainer}>
            ...
            <div style={styles.stepCard}>
              ...
              <ul style={styles.stepDetails}>
                <li style={styles.listItem}>
                  ...
                  <span style={styles.listText}>Set eligibility criteria (target score range, industry focus)</span>
                </li>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Define focus areas and program structure</span>
                </li>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Establish timelines and application process</span>
                </li>
              </ul>
              <p style={styles.stepSubtext}>📋 Customize for your program's unique needs</p>
            </div>
            ...
            <div style={styles.stepCard}>
              ...
              <ul style={styles.stepDetails}>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Auto-matched applicants based on your criteria</span>
                </li>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>View score history and growth metrics</span>
                </li>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Assess potential through comprehensive profiles</span>
                </li>
              </ul>
              <p style={styles.stepSubtext}>🔍 Find the perfect fit for your program</p>
            </div>
            ...
            <div style={styles.stepCard}>
              ...
              <ul style={styles.stepDetails}>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Track improvements in scores and revenue</span>
                </li>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Generate detailed performance reports</span>
                </li>
                <li style={styles.listItem}>
                  <span style={styles.customBullet}>✓</span>
                  <span style={styles.listText}>Showcase success stories to attract funders</span>
                </li>
              </ul>
              <p style={styles.stepSubtext}>📈 Demonstrate your program's impact</p>
            </div>
          </div>

          {/* Video Section */}
          <div style={styles.videosContainer}>
            <h2 style={styles.videosTitle}>See How Catalysts Make an Impact</h2>
            <div style={styles.videoWrapper}>
              <video 
                controls 
                style={styles.videoElement}
                poster="/video-thumbnail-catalysts.jpg" // Optional thumbnail
              >
          ...
          >
            Join as Partner
            <div style={styles.ctaSubtext}>Connect with high-potential SMEs today</div>
          </button>
        </div>
      </div>
