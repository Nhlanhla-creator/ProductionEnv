    ...
    <>
      <header style={styles.header}>
        ...
        <div style={styles.logoContainer}>
          <picture onClick={() => handleNavigation('/HomePageProgram')}>
        ...
        <div style={styles.navContainer} className="desktop-nav">
          <nav style={styles.nav}>
            <button 
              ...
              onClick={() => handleNavigation('/HomePageProgram')}
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HowWorksProgram')}
              style={styles.navButton}
            >
              How it works
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/BIGscoreProgram')}
              style={styles.navButton}
            >
              BIG score
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/InsightsProgram')}
              style={styles.navButton}
            >
              Insights
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/FAQsProgram')}
              style={styles.navButton}
            >
              FAQs
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/ContactProgram')}
              style={styles.navButton}
            >
              Contact Us
            </button>
