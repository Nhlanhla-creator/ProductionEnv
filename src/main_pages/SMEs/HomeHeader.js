      ...
      <header style={styles.header}>
        ...
        <div style={styles.navContainer} className="desktop-nav">
          <nav style={styles.nav}>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HomeHowItWorks')}
              style={styles.navButton}
            >
              How it works
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HomeBigScorePage')}
              style={styles.navButton}
            >
              BIG score
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HomeInsightsPage')}
              style={styles.navButton}
            >
              Insights
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HomeFAQPage')}
              style={styles.navButton}
            >
              FAQs
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HomeContactFormPage')}
              style={styles.navButton}
            >
              Contact Us
            </button>
