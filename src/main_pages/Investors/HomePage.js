...
import HomeHeader from './HeaderInvestors';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            You're accessing a meta-testing environment
          </h2>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            The BIG Marketplace platform is currently in beta and under active development. All features, content, and functionality are subject to change and may not represent the final version. Any data entered during this phase may not be retained when the platform moves to production.
          </p>
        </div>
        ...
        <p style={{
          ...
          Your participation in this early testing phase is incredibly valuable. It helps us shape a better platform for Africa's boldest businesses.
        </p>
        ...
        <p style={{
          ...
          If you encounter issues or have suggestions, please share your feedback through our official channels.
        </p>
...
const HomePageInvestor = () => {
  ...
  const benefitCards = [
    ...
    },
    {
      ...
      howItWorksLink: "/HowItWorksAccelerators",
  ...
  return (
    <div className="landing-page" style={{ 
      ...
      <div style={{
        ...
        {/* Main Content - Takes 80% of screen */}
        <div style={{
          width: '80%',
          padding: '20px',
          overflowY: 'auto'
          ...
          <section style={{ 
            ...
            <div style={{
              position: 'absolute',
              bottom: isMobile ? '10px' : '70px', // Adjusted position to be lower
    ...
    <div style={{
      ...
      <div className="benefit-card" style={{
        ...
        <div className="tooltip">
          SMSEs = Small, Medium and Social Enterprises.
        </div>
        <div style={{
        ...
        <p style={{
          ...
          Get matched with the right funders, service providers, and strategic support — all through one universal profile and your BIG Score.
        </p>
      ...
      <div className="benefit-card" style={{
        ...
        <p style={{
          ...
          Access verified, investment-ready SMEs with transparent scoring, compliance checks, and predictive insights.
        </p>
        <div style={{ marginTop: 'auto' }}>
          <Link
            to="/HowItWorksInvestors"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              color: colors.secondary,
      ...
      <div className="benefit-card" style={{
        ...
        <p style={{
          ...
          Whether you're an incubator, accelerator, or donor — support high-potential SMEs and monitor cohort outcomes via the BIG Score.
        </p>
        <div style={{ marginTop: 'auto' }}>
          <Link
            to="/HowItWorksAccelerators"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              color: colors.accent,
      ...
      <div className="benefit-card" style={{
        ...
        <div className="tooltip">
          Join as a strategic advisor or board candidate. Get matched to businesses that need your skills — and get recognized.
        </div>
        <div style={{
          backgroundColor: `${colors.accent}10`,
          width: '60px',
          ...
          <FaUserTie size={24} color={colors.accent} />
        </div>
        <h3 style={{
          fontSize: isMobile ? '1.2rem' : '1.3rem',
          fontWeight: '700',
        ...
        <p style={{
          ...
          Connect with businesses that need your expertise and grow your advisory practice.
        </p>
        <div style={{ marginTop: 'auto' }}>
          <Link
            to="/HowItWorksAdvisors"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              color: colors.accent,
