        ...
        <div style={styles.navContainer} className="desktop-nav">
          <nav style={styles.nav}>
            <button 
              ...
              onClick={() => handleNavigation('/HomePageInvestor')}
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HowItWorksInvestor')}
              style={styles.navButton}
            >
              How it works
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/BIGScoreInvestor')}
              style={styles.navButton}
            >
              BIG score
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/InsightsInvestor')}
              style={styles.navButton}
            >
              Insights
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/FAQPageInvestor')}
              style={styles.navButton}
            >
              FAQs
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/ContactFormInvestor')}
              style={styles.navButton}
            >
              Contact Us
            </button>
