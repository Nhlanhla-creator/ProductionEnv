  ...
  return (
    <>
        ...
        <div style={styles.navContainer} className="desktop-nav">
          <nav style={styles.nav}>
            <button 
              ...
              onClick={() => handleNavigation('/HomePageInterns')}
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HowWorksInterns')}
              style={styles.navButton}
            >
              How it works
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/BIGscoreInterns')}
              style={styles.navButton}
            >
              BIG score
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/FAQsInterns')}
              style={styles.navButton}
            >
              FAQs
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/ContactInterns')}
              style={styles.navButton}
            >
              Contact Us
            </button>
      ...
      <div style={styles.mobileMenu}>
        ...
        <button 
          style={styles.mobileNavButton}
          onClick={() => handleNavigation('/InsightsInterns')}
        >
          Insights
        </button>
