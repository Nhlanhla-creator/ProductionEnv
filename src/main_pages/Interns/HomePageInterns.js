...
const  HomePageInterns= () => {
  ...
  const benefitCards = [
    ...
    {
      title: "Interns",
      icon: <FaUsers size={24} color="#A8A8A8" />,
      color: "#A8A8A8",
...
<section style={{ 
  ...
  <div style={{
    ...
    <div style={{
      ...
      {benefitCards.slice(0, 3).map((card, index) => (
        <div
          key={index}
    ...
    {/* Bottom Row - Last 3 Benefit Cards */}
    <div style={{
      display: 'grid',
      gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)',
      gap: '15px',
    }}>
      {benefitCards.slice(3, 6).map((card, index) => (
        <div
          key={index}
          className="benefit-card"
          style={{
...
export default HomePageInterns;