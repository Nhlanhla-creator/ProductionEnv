...
import HomeHeader from './HeaderInterns'
import HomeFooter from '../SMEs/HomeFooter';
import Sidebar from '../../Interns/sidebar/sidebar';

const BIGscoreInterns = () => {
  ...
  const scoreData = {
    bigScore: {
      ...
      components: [
        ...
        {
          title: "PIS Score (Pre-Institutional Structure)",
          ...
          detailedDescription: "🏗 This score tracks your journey from informal to investable.",
          ...
          subComponents: [
            {
              ...
              weightings: {
                seed: { value: "30%", description: "Basic advisory" },
                growth: { value: "20%", description: "Developing advisory" },
                maturity: { value: "10%", description: "Mature advisory" }
              }
            },
            {
              ...
              weightings: {
                seed: { value: "20%", description: "Basic board" },
                growth: { value: "25%", description: "Developing board" },
            ...
            },
            {
              ...
              weightings: {
                seed: { value: "25%", description: "Basic structure" },
                growth: { value: "25%", description: "Developing structure" },
            ...
            },
            {
              ...
              weightings: {
                seed: { value: "15%", description: "Basic reporting" },
                growth: { value: "15%", description: "Developing reporting" },
  ...
  const ScoreBox = ({ component, index, openPopup }) => {
    const componentImages = {
      ...
      "PIS Score (Pre-Institutional Structure)": "https://media.istockphoto.com/id/639198068/photo/business-people-finding-solution-together-at-office.jpg?s=612x612&w=0&k=20&c=apxfQgMQ4KfWvTxdtyefbxIRiK0DVk7lFr4GbGSniR8="
    };
...
export default BIGscoreInterns;