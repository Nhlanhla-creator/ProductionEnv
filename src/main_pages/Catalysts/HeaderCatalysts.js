        ...
        <div style={styles.navContainer} className="desktop-nav">
          <nav style={styles.nav}>
            <button 
              ...
              onClick={() => handleNavigation('/HomePageCatalysts')}
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/HowWorksCatalysts')}
              style={styles.navButton}
            >
              How it works
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/BIGscoreCatalysts')}
              style={styles.navButton}
            >
              BIG score
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/InsightsCatalysts')}
              style={styles.navButton}
            >
              Insights
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/FAQsCatalysts')}
              style={styles.navButton}
            >
              FAQs
            </button>
            ...
            <button 
              className="nav-button"
              onClick={() => handleNavigation('/ContactCatalysts')}
              style={styles.navButton}
            >
              Contact Us
            </button>
...
export default HeaderCatalysts;